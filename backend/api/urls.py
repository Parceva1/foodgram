...
urlpatterns = [
    path('auth/token/login/', CustomTokenObtainView.as_view(), name='token_obtain_pair'),
    path('auth/token/logout/', LogoutView.as_view(), name='logout'),

    path('users/me/', CurrentUserView.as_view(), name='current_user'),
    path('users/<int:id>/', UserProfileView.as_view(), name='user-profile-detail'),
    ...
    path('recipes/<int:pk>/get-link/', RecipeShortLinkView.as_view(), name='recipe-short-link'),
    path('recipes/<int:pk>/shopping_cart/', ShoppingCartView.as_view(), name='shopping-cart'),
    path('recipes/download_shopping_cart/', DownloadShoppingCartView.as_view(), name='download-shopping-cart'),
    path('recipes/<int:pk>/favorite/', FavoriteView.as_view(), name='favorite'),
